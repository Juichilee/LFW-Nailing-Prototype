...
public class OVRGrabber : MonoBehaviour
{
    ...
    public bool pinching; // Check if the controller is currently pinching.
    ...
    void OnUpdatedAnchors()
    {
        ...
        // Include pinching holds to grab.
        
        if (OVRInput.Get(OVRInput.Axis1D.PrimaryIndexTrigger, m_controller) >= 0.55f && OVRInput.Get(OVRInput.NearTouch.PrimaryThumbButtons, m_controller) == true)
        {
    ...
    protected virtual void GrabBegin()
    {
        ...
        if (closestGrabbable != null)
        {
            ...
            if(m_grabbedObj.snapPosition && pinching == false)  //included to check pinching
            {
            ...
            if (m_grabbedObj.snapOrientation && pinching == false) //included to check pinching
            {
    ...
    protected virtual void MoveGrabbedObject(Vector3 pos, Quaternion rot, bool forceTeleport = false)
    {
        ...
        if (m_grabbedObj.snapOffset == true && pinching == false) // Included to check pinching
        {
            // Fix the rotation for the left hand.
            m_grabbedObjectPosOff = m_gripTransform.localPosition;
            if (m_grabbedObj.snapOffset)
            {
                Vector3 snapOffset = m_grabbedObj.snapOffset.position;
