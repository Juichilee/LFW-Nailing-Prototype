...
public class OVRGrabbable : MonoBehaviour
{
    ...
    public OVRGrabber m_grabbedBy = null; // Changed from protected
    ...
    public Collider[] grabPoints
    {
        ...
        // Added for nailable object script
        set
        {
            this.m_grabPoints = value;
        }
    }
    ...
    void Awake()
    {
        ...
        {
            Debug.Log("Seals", m_grabPoints[i].gameObject);
        }
    }
